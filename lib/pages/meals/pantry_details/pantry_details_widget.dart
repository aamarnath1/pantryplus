  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      child: Scaffold(
        ...
        //     String itemName = pantryItems[index]['name'];
        //     String expiryDate = pantryItems[index]['expiry_date'];
...
//   final data;
//   ShelfDesign({required this.data});
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Shelf Design'),
//       ),
//       body: Padding(
//         padding: const EdgeInsets.all(16.0),
//         child: Shelf(items: data),
//       ),
//     );
//   }
// }
...
//   final items;
//   final int itemsPerRack = 4; // Number of items per rack

//   Shelf({required this.items});
